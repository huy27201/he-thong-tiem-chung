...
<<<<<<< HEAD
                optionsBuilder.UseSqlServer(@"Server=DESKTOP-1E3RHRQ\SQLEXPRESS;Database=HTTiemChungDB;Trusted_Connection=True;");
=======
                optionsBuilder.UseSqlServer(@"Server=HIT\SQLEXPRESS;Database=HTTiemChungDB;Trusted_Connection=True;User ID = HIT\Admin");
>>>>>>> master
            }
        }
